...
.diagnostic-summary{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:12px}.diagnostic-table{width:100%;border-collapse:collapse;font-size:11px}.diagnostic-table th{text-align:left;color:var(--muted);padding:0 7px 8px;text-transform:uppercase;font-size:9px}.diagnostic-table td{padding:9px 7px;border-top:1px solid var(--line);vertical-align:top}.diagnostic-table .num{text-align:right}.diagnostic-warn{color:var(--amber)}
